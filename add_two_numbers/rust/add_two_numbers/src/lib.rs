...
pub fn add_two_numbers_iteratively(l1: Option<Box<ListNode>>, l2: Option<Box<ListNode>>) -> Option<Box<ListNode>> {
...
pub fn add_two_numbers_recursively(l1: Option<Box<ListNode>>, l2: Option<Box<ListNode>>) -> Option<Box<ListNode>> {
    add(l1, l2, 0)
}
